...
function rex() {
  return Promise.all([
    ...
    let text = [
    "rex",
    "Name: Metal Gear Rex<br> First Appearance: 1998<br> Model Date: 1998<br> Description: Armoured bipedal tank for launching nuclear warheads from the MetalGear series<br>"
    ];
    let modelId = "rex";
