...
function Crash() {
  ...
  detailedPedestal().then((real) => {
    loader.load("models/GameCharacters/CrashBandicoot/Crash.fbx", (obj) => {
      ...
      ped.position.set(140, 1, -130);
      obj.position.set(0.5, 14.4, 0);
      obj.rotation.set(Math.degToRad(180), Math.degToRad(90), 0);
      addCollider(ped);
